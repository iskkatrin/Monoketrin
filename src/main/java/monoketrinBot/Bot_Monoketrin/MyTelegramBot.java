        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            if ("/start".equals(messageText)) {
                ...
                message.setText("Отлично, благодарю тебя за ответ, чтобы получить подарок, нажми на кнопку ниже.\n\n" +
                        "\"ПОШАГОВАЯ ИНСТРУКЦИЯ, КАК ПИСАТЬ ПРОГРЕВЫ НЕШАБЛОННО\", благодаря этому уроку ты сможешь научиться писать так, что тебя будут хотеть все.\n\n" +
                        "Внутри урока я разобрала:\n\n" +
                        "- пошаговая схема, как писать нешаблонно\n" +
                        "- практики, которые прокачают ваш креатив\n" +
                        "- как продавать, но чтобы было не душно?\n" +
                        "- мои примеры сторителлов\n" +
